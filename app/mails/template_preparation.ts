...
export default class TemplatePreparation extends BaseMail {
    ...
    constructor(htmlFromDb : string ,subject : string, contact: {id: number, first_name: string; last_name: string; email: string } , project: { id: number; name: string } , callsheet: Callsheet , to_contact: { first_name: string; last_name: string; email: string; phone: string; messenger: string }, registration: { id: number; project_id: number }) {
        super()
